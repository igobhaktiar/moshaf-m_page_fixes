...
class DuaKhatmQuranPage extends StatelessWidget {
  const DuaKhatmQuranPage({Key? key}) : super(key: key);
          ...
          children: [
            Center(
              child: SizedBox(
                ...
                child: Image.asset(AppAssets.supplication, fit: BoxFit.contain),
              ),
            ),
            ...
            const Text(
              ...
              style: TextStyle(
                fontSize: 18,
                height: 1.8,
                fontFamily: AppStrings.notoNaskhArabicRegular,
              ),
